...
### Danni Enrico - 5B INF - I.I.S. Vallauri, Fossano (CN)

# About the course

Questa diventerà un'app per la compilazione di una lista della spesa. <br>
Questa app include una collezione di ricette che gli utente avranno la possibilità di visionare e editare i dettagli.
